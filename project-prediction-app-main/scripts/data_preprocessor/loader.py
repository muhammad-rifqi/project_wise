...
class DataLoader:
    ...
    def load_all_data(self):
        ...
        try:
            ...
            allocations = pd.read_csv('/xampp/htdocs/project_wise/project-prediction-app-main/data/raw/allocations.csv')
            projects = pd.read_csv('/xampp/htdocs/project_wise/project-prediction-app-main/data/raw/projects.csv')
            team_members = pd.read_csv('/xampp/htdocs/project_wise/project-prediction-app-main/data/raw/team_members.csv')
